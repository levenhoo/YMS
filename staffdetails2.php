...
<html>
 ...
 <div class="container-fluid"><!-- body -->
  ...
  <div class="control-group">
      ...
      <div class="controls">
          <input onclick="WdatePicker();"  class="span2 date-picker"   name="jobdate" value="<?=$jobdate?>"  placeholder="入职日期" id="jobdate" type="text" data-date-format="yyyy-mm-dd">
          <span class="add-on"><i class="icon-calendar"></i></span>
...
<script language="javascript" type="text/javascript" src="theme/My97DatePicker/WdatePicker.js"></script>
<script> 
